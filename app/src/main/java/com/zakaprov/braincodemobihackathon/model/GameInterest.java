...
public class GameInterest extends Interest {
    ...
    public AllegroQuery[] getQueries() {
        ...
        tab[1] = new AllegroQuery(this.title + " plakat", "0", "plakaty");
        tab[2] = new AllegroQuery(this.title + " OST", "0", "soundtracki");
        tab[3] = new AllegroQuery(this.title + " gadżet", "0", "gadżety");
